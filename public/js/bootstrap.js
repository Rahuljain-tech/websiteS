    ...
    (function () {
      ...
      _proto._getConfig = function _getConfig(config) {
        config = _objectSpread(
          {},
          this.varructor.Default,
          $(this._element).data(),
          config
        );
        Util.typeCheckConfig(NAME$4, config, this.varructor.DefaultType);
        return config;
      };
  ...
  var Tooltip =
    ...
    (function () {
      ...
      _proto.toggle = function toggle(event) {
        ...
        if (event) {
          var dataKey = this.varructor.DATA_KEY;
          var context = $(event.currentTarget).data(dataKey);

          if (!context) {
            context = new this.varructor(
              event.currentTarget,
      ...
      _proto.dispose = function dispose() {
        ...
        $.removeData(this.element, this.varructor.DATA_KEY);
        $(this.element).off(this.varructor.EVENT_KEY);
      ...
      _proto.show = function show() {
        ...
        var showEvent = $.Event(this.varructor.Event.SHOW);
        ...
        if (this.isWithContent() && this._isEnabled) {
          ...
          var tipId = Util.getUID(this.varructor.NAME);
          ...
          $(tip).data(this.varructor.DATA_KEY, this);
          ...
          $(this.element).trigger(this.varructor.Event.INSERTED);
          ...
          var complete = function complete() {
            ...
            $(_this.element).trigger(_this.varructor.Event.SHOWN);
      ...
      _proto.hide = function hide(callback) {
        ...
        var tip = this.getTipElement();
        var hideEvent = $.Event(this.varructor.Event.HIDE);
        ...
        var complete = function complete() {
          ...
          $(_this2.element).trigger(_this2.varructor.Event.HIDDEN);
          ...
          if (trigger === "click") {
            ...
            var eventIn =
              trigger === Trigger.HOVER
                ? _this4.varructor.Event.MOUSEENTER
                : _this4.varructor.Event.FOCUSIN;
            var eventOut =
              trigger === Trigger.HOVER
                ? _this4.varructor.Event.MOUSELEAVE
                : _this4.varructor.Event.FOCUSOUT;
            $(_this4.element)
      ...
      _proto._getConfig = function _getConfig(config) {
        ...
        Util.typeCheckConfig(NAME$6, config, this.varructor.DefaultType);
      ...
      _proto._getDelegateConfig = function _getDelegateConfig() {
        ...
        if (this.config) {
          for (var key in this.config) {
            if (this.varructor.Default[key] !== this.config[key]) {
  ...
  var Toast =
    ...
    (function () {
      ...
      _proto._getConfig = function _getConfig(config) {
        ...
        Util.typeCheckConfig(NAME$a, config, this.varructor.DefaultType);
        return config;
      };
